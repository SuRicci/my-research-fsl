...
HERE=Path(__file__).resolve().parent;ROOT=next(p for p in HERE.parents if (p/'research_directions.json').is_file())
R1=ROOT/'研究5——少样本支持集的检索增强与可靠性加权'/'studies/r1_20260909'
